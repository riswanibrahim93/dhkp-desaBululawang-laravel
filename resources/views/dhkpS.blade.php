...
<div class="col-md-12" style="margin-bottom: 30px">
  ...
  <a href="{{ route('excel.export') }}" type="button" class="btn btn-primary float-right" style="margin-bottom: 10px;">EXPORT TO EXCEL</a>

  <div class="modal fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <form method="post" action="/data/import-xlxs" enctype="multipart/form-data">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="dhkpForm" name="dhkpForm" class="form-horizontal">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-12">
                    <input type="text" class="form-control" id="c" name="c" placeholder="Masukkan Persil" value="">
                  </div>
                </div>
            ...
            <div class="col-md-12">
              <div align="center" id="map" style="width: 100%; height: 420px"><br/></div>
              <p hidden id="lat"></p>
              <p hidden id="lng"></p>
